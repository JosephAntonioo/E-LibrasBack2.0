...
from modulos.alfabeto import letras
...
async def final(img):
    ...
    if(check):
        ...
        # Dedo polegar
        # print('------POSICOES DOS DEDOS------')
        polegarM = posicao.verificar_posicao_DEDOS(pontos[1:5], 'polegar', altura.verificar_altura_MAO(pontos))
        # Dedo indicador
        indicadorM = posicao.verificar_posicao_DEDOS(pontos[5:9], 'indicador', altura.verificar_altura_MAO(pontos))
        # Dedo médio
        medioM = posicao.verificar_posicao_DEDOS(pontos[9:13], 'medio', altura.verificar_altura_MAO(pontos))
        # Dedo anelar
        anelarM = posicao.verificar_posicao_DEDOS(pontos[13:17], 'anelar', altura.verificar_altura_MAO(pontos))
        # Dedo mínimo
        minimoM = posicao.verificar_posicao_DEDOS(pontos[17:21], 'minimo', altura.verificar_altura_MAO(pontos))
        # print('------POSICOES DOS DEDOS------')
        # print('polegar: ', polegarM)
        # print('indicadorM: ', indicadorM)
        # print('medio: ', medioM)
        # print('anelar: ', anelarM)
        # print('minimo: ', minimoM)
        
        atual = proximidade.verificar_proximidade_DEDOS(pontos)
        print(atual)
        # return atual por enquanto por causa do mobile sla oq ta dando aqui 
        for i, a in enumerate(alfabeto.letras):
            if(alfabeto.letras[i] == atual):
                # print('I(index do alfabeto):')
                # print(i)
        ...
        return 'Nao foi possível identificar a mao!'
